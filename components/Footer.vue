<template>
    <footer>
        <div class="mx-4 lg:mx-32 bg-gradient-to-t from-stone-50 to-amber-200/10 rounded-t-2xl px-8 pt-8 pb-6 lg:px-10 lg:pt-10 text-gray-700">
            <div class="flex gap-x-2 items-center">
                <p class="mt-2"><Icon name="lucide:waves" class="text-3xl lg:text-4xl text-amber-600" /></p>
                <h2 class="font-anek text-4xl font-bold">
                    Kontak Kami
                </h2>
            </div>
            ...
            <div class="mt-6 pt-4 border-t text-gray-600 text-center">
                <p class="text-sm">
                    All Rights Reserved © Sastra Adventure, 2024
                </p>
            </div>
        </div>
    </footer>
